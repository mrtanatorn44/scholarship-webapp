  ...
  function onHandleSubmitBtn(e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.post("http://localhost:5000/addForm", {
          user_id         : user.id,
          scholarship_id  : parseInt(localStorage.getItem('scholarshipRegisterID_target')),
        ...
        <div className="contents"> 
          <div className="content3"> 
            <form className="form2" onSubmit={(e)=> {onHandleSubmitBtn(e);}}>
              <div className="name">
              <h5>ลงทะเบียนทุน - {scholar.type}</h5>
              <center><label>ประจำปีการศึกษา {scholar.on_year} {scholar.on_term}</label></center>
